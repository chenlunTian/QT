...
*设置曲线名称
*要在曲线放置在布局之前放置
*plot->setCurveName(1,"sin");
*qDebug()<<"getCurveName"<<plot->getCurveName(1);
...
void MultiCurvesPlot::setCurveName(int idx, const QString newName)
{
    ...
    if(idx < getName.size())
    {
//         qDebug() << "getName.size()"<<getName.size();
        getName[idx] = newName;
    }
    else
...
//    qDebug() << "allCurvesData.valVec"<<idx<<allCurvesData[idx].valVec;
 ...
 * 总会出BUG不使用
 * ****/
void MultiCurvesPlot::setLegendPosition()
{
    QMargins marg(0,0,0,0);
    this->legend->addElement(0,0,this->legend->item(0));
    this->legend->addElement(0,1,this->legend->item(1));
    this->legend->addElement(0,2,this->legend->item(2));
    this->legend->addElement(0,3,this->legend->item(3));
    this->legend->addElement(0,4,this->legend->item(4));
    this->legend->addElement(0,5,this->legend->item(5));
    this->legend->addElement(0,6,this->legend->item(6));
    this->legend->addElement(0,7,this->legend->item(7));
    this->legend->addElement(0,8,this->legend->item(8));
    this->legend->addElement(0,9,this->legend->item(9));
